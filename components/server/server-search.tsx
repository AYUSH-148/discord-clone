    ...
    return (
        <>
            <button onClick={()=>setOpen(true)} className='group px-2 py-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition'>
                ...
                {/* The <kbd> element in HTML is used to define keyboard input. It represents user input that typically comes from the keyboard, such as keystrokes, keyboard shortcuts, or other keyboard actions. */}
                <kbd className='pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border bg-muted font-mono text-[10px] font-medium text-muted-foreground ml-auto '>
                    <span className='text-xs mx-1'>cmd k</span> 
                </kbd>
            </button>
